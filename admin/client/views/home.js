            ...
            <div className="dashboard-group__list">
                <span className="dashboard-group__list-inner">
                    ...
                    >
                        ...
                        <div className="dashboard-group__list-count">
                            {this.props.count}
                        </div>
                    </a>
                    <a
                        href={this.props.href + '?create'}
...
var HomeView = React.createClass({
    ...
    renderFlatNav() {
        let lists = this.props.navLists.map((list) => {
            var href = list.external
                ? list.path
                : `${Keystone.adminPath}/${list.path}`
            return (
                <ListTile
                    key={list.path}
                    label={list.label}
                    ...
                    return (
                        <div className="dashboard-group" key={navSection.key}>
                            <div className="dashboard-group__heading">
                                <span
                                    className={this.getHeadingIconClasses(
                                        navSection.key
                                    )}
                                />
                                {navSection.label}
